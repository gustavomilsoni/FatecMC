...
<body>
	...
	<div class="container">
		...
		<form name="frmCadCli" action="Grafico" method="post">	
			<div class="form-group row">
				  <label for="example-date-input" class="col-2 col-form-label">Data inicial:</label>
				  <div class="col-10">
				    <input class="form-control" type="date" name="txtDataInicial" value="" />
				  </div>
			</div>
			...
			<div class="form-group row">
				  ...
				  <div class="col-10">
				    <input class="form-control" type="date" value="" name="txtDataFinal" />
				  </div>
			</div>
