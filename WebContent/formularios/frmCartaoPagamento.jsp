...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				...
				<%
					...
					if (usuario != null) {
						...
						for (Endereco end : usuario.getPessoa().getEnderecos()) {
						 
							if (end.getId() == Integer.valueOf(request.getParameter("txtId"))) {
								session.setAttribute("enderecoEntrega", end);
							}
						 }
						}
  ...
  <div class="pb-5">
    <div class="container">
	  <h3 class="title_confirmation">Cartão para pagamento</h3>
      <div class="row">
              ...
              <thead>
                <tr>
                  <th scope="col" class="border-0 bg-light">
                    <div class="p-2 px-3 text-uppercase">Número</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">Validade</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">Bandeira</div>
                  </th>
              ...
              <tbody>
                 ...
                 <%       
							...
							for (int i = 0; i < cliente.getCartoes().size(); i++) {
								p = (Cartao) cliente.getCartoes().get(i);
%>
				                <tr>
				                  <th scope="row" class="border-0">
				                    <div class="p-2">
				                      ...
				                      <div class="ml-3 d-inline-block align-middle">
				                        <h5 class="mb-0"> <a href="frmConfirmacao.jsp?txtId=<%=p.getId()%>&OPERACAO=CARTAO_PAG" class="text-dark d-inline-block align-middle"><%=p.getNumCartao()%></a></h5>
				                      </div>
				                    </div>
				                  </th>
				                  <td class="border-0 align-middle"><strong><%=p.getValidade()%></strong></td>
				                  <td class="border-0 align-middle"><strong><%=p.getBandeira().getNome()%></strong></td>
          ...
          <!-- End -->
            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-8">
                        <h3>Informação do novo cartão</h3>

                        <form name="frmCartaoPag" action="CartaoPag" method="post">
						
							<div class="col-md-12 form-group p_star">
                                <select class="country_select" name="cmbBandeira">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="company" name="txtNomeCart" placeholder="Nome do Títular">
                            </div>
							<div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="company" name="txtNumCartao" placeholder="Número">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="company" name="txtValidade" placeholder="Validade">
                            </div>
							<div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="company" name="txtCvv" placeholder="CVV">
                            </div>
