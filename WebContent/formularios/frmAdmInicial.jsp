...
<body>
	...
	<!-- End Banner Area -->
	<div class="container">
			<form name="frmAdm" action="CadCli" method="post">
			
				<input type="submit" id="OPERACAO" name="OPERACAO" formaction="Pedido" value="TROCAS" />
				<button>
					<a href="frmData.jsp">Gráfico</a>
				</button>
				<button>
					<a href="frmCadProduto.jsp">Produtos</a>
				</button>
