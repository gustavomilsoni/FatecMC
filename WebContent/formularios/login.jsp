				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>Cadastre-se e utilize todos os benefícios.</p>
							<a class="primary-btn" href="frmCadCli.jsp">Criar nova conta</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					...
					<div class="login_form_inner">
						<h3>Entre com o usuario e senha</h3>
						<form class="row login_form" action="Login" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="txtEmail" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Usuário'">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="name" name="txtSenha" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Senha'">
							</div>
		
		
							<div class="col-md-12 form-group">
								<button type="submit" id="OPERACAO" name="OPERACAO" value="LOGIN" class="primary-btn">Acessar</button>
