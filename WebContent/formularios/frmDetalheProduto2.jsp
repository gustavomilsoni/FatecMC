			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="livro1.png" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="livro1.png" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Algoritmos: Lógica para desenvolvimento de programação de computadores</h3>

						<ul class="list">
							<li><a class="active" href="#"><span>Autor</span> :  Jayr Figueiredo de Oliveira e José Augusto N. G. Manzano </a></li>
						</ul>
						<p>A obra aborda aspectos históricos, como origem, fundamentação, breve análise da programação estruturada
						em comparação com a programação orientada a objetos. Apresenta o resumo dos principais termos usados e 
						discute a questão do polimorfismo versus poliformismo. Também trata de classe, objeto, atributo, método, herança 
						e encapsulamento, com alguns exemplos de aplicação para auxiliar a compreensão. Nesta edição foram acrescentados 
						a implementação de um exemplo de uso de matriz em</p>
						<form name="frmCadCli" action="ItemCarrinho" method="post">
						<div class="product_count">
							<label for="qty">Quantidade:</label>
							<input type="hidden" id="txtPreco" name="txtPreco" value="101.00">
							<input type="hidden" name="txtCodProd" value="2" />
