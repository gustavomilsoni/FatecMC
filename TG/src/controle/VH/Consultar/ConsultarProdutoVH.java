...
public class ConsultarProdutoVH extends AbstractViewHelper{
	...
	public EntidadeDominio getEntidade(HttpServletRequest request) {
		...
		if (request.getParameter("txtMargem") != null && request.getParameter("txtMargem") !="" ){
	...
	public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response) {
		...
		if(resultado.getEntidades() == null && (resultado.getMsg() == null || resultado.getMsg().equals("")) ) {
			resultado.setMsg("Não existe registro");
