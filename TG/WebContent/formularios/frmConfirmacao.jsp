                ...
                <div class="row">
                    <div class="col-lg-8">
                        <h3>Informação do endereço</h3>
							...
							<div class="col-md-12 form-group p_star">
								<select name="cmbTipoEndereco">
									...
									<option value="Cobrança"
										<%=end.getTipoEndereco().equals("Cobrança") ? "selected" : ""%>>Cobrança</option>
								</select>
                            </div>
							<div class="col-md-12 form-group p_star">
							...
							<div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="company" name="txtNumero" 
                                value="<%=end.getNumero()%>" placeholder="Número">
                            </div>
                            <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                value="<%=end.getObservacoes()%>" placeholder="Observações"></textarea>
                            </div>
