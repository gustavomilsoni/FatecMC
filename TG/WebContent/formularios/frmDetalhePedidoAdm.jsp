            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">Autor</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">Quantidade</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">Autorizar</div>
                  </th>
              ...
              <tbody>
              	...
              	if (entidades != null) {
					...
					for (EntidadeDominio ent : entidades) {
						...
						if (ent.getId() == Integer.parseInt(request.getParameter("txtId"))) {
					                  ...
					                  <th scope="row" class="border-0">
					                    <div class="p-2">
					                      ...
					                      <div class="ml-3 d-inline-block align-middle">
					                        <h5 class="mb-0"> <a href="frmDetalhePedido.jsp?txtId=<%=p.getId()%>&OPERACAO=VISUALIZAR" class="text-dark d-inline-block align-middle"><%=p.getLivro().getTitulo()%></a></h5>
					                      </div>
					                    </div>
					                  </th>

					                  <td class="border-0 align-middle"><strong><%=p.getLivro().getAutor()%></strong></td>
					                  <td class="border-0 align-middle"><strong><%=p.getQuantidade()%></strong></td>
					           		...
					           		<th scope="row" class="border-0">
					                    <div class="p-2">
					                      ...
					                      <div class="ml-3 d-inline-block align-middle">
					                        <h5 class="mb-0"> <a href="Pedido?txtId=<%=p.getId()%>&txtPedidoId=<%=pedido.getId()%>&OPERACAO=AUTORIZAR_TROCA" class="text-dark d-inline-block align-middle">Autorizar</a></h5>
					                      </div>
					                    </div>
					                  </th>
